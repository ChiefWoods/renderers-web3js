...
/** Prefer concrete generated subpaths; use the module alias as-is when overridden. */
export function getLinkImportPath(importFrom: string, name: string): string {
    ...
    if (generatedPrefixes.includes(importFrom)) {
